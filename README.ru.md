...
- **Масштаб только документа** — `Ctrl+колесо` меняет размер текста предпросмотра и редактора, не увеличивая вкладки и панели. Щёлкните процент или нажмите `Ctrl+0`, чтобы вернуть 100 %; масштаб сохраняется между запусками.
